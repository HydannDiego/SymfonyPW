 ...
 */
final class Version20221227220846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bien (id INT AUTO_INCREMENT NOT NULL, id_categorie_id INT NOT NULL, titre VARCHAR(60) NOT NULL, description VARCHAR(255) DEFAULT NULL, is_locatif TINYINT(1) NOT NULL, prix INT NOT NULL, ville VARCHAR(100) NOT NULL, cp VARCHAR(5) NOT NULL, surface INT NOT NULL, ref VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_45EDC3869F34925F (id_categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_fav (id INT AUTO_INCREMENT NOT NULL, email_user VARCHAR(255) NOT NULL, date_envoie VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
